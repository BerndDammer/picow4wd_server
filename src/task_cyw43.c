...
void thread_cyw43_init(MainEnvironement_t *MainEnvironement)
{
...
void task_cyw43_init(MainEnvironement_t *MainEnvironement)
{
	xTaskCreate((CALLEE)thread_cyw43_init, "CYW43_INIT", configMINIMAL_STACK_SIZE, MainEnvironement,
